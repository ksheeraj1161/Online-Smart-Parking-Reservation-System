...
if(isset($_POST['login']))
  {
    ...
    $query=mysqli_query($con,"select ID from tbluser where  UserName='$adminuser' && Password='$password' ");
...
<body style="background-image: url('img_bg2.jpg');">
        ...
        <div class="container">
            <div class="login-content">
                <div class="login-logo">
                    <a href="index.php">
                        <h2 style="color: #000">Smart Parking Reservation System</h2>
                    </a>
                </div>
    ...
    echo $msg;
                        ...
                        <div class="checkbox">
                            ...
                            <label class="pull-right">
                                <a href="user-forgot-password.php">Sign Up</a>
                            </label>
